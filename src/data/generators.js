...
//
// costGrowth is the genre-standard 1.15 (cost doubles ~every 5 buys). With
// mutations/research now ADDITIVE (not multiplicative), the exponential cost wall
// is the real progression engine — you grow by buying MORE organelles up the
// curve, the way Cookie Clicker works, instead of a runaway multiplier.
